...
experiments = mlflow.search_experiments(
    filter_string="tags.repository_name='end-to-end-mlops-databricks-3/marvelous-databricks-course-NJBAza'"
)
print(experiments)
...
# get active run
mlflow.get_run(run_id="b92ccc218aa645aab173d0810bf243d7")
...
mlflow.search_runs(
    experiment_names=["/Shared/satisfaction_customer"],
